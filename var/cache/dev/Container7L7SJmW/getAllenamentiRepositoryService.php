...
// Returns the private 'App\Repository\AllenamentiRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AllenamentiRepository.php';

return $this->privates['App\Repository\AllenamentiRepository'] = new \App\Repository\AllenamentiRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
