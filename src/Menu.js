            ...
            <div>
                            ...
                            <li className="active treeview menu-open">
                                ...
                                <ul className="treeview-menu">
                                   {/* <li><a href="index.html"><i className="fa fa-circle-o" /> Dashboard v1</a></li>*/}
                                    <li className="active"><a href="dashboard.html"><i className="fa fa-circle-o" /> Dashboard v1</a></li>
                                </ul>
                            </li>
                ...
                <span className="pull-right-container">
                    ...
                    <span className="pull-right-container">
                            ...
                            <li><a href="fake_url"><i className="fa fa-circle-o text-red" /> <span>Impoertanti</span></a></li>
                            <li><a href="fake_url"><i className="fa fa-circle-o text-yellow" /> <span>Avvisi</span></a></li>
                            <li><a href="fake_url"><i className="fa fa-circle-o text-aqua" /> <span>Informazioni</span></a></li>
                        </ul>
                    </section>
                    {/* /.sidebar */}
                </aside>
